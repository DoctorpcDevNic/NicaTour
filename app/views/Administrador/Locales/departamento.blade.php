...
@section('contenido')
	...
	<div class="container-fluid">
		<h2 class="titul">{{$local}} en {{$depto->nombre}}</h2>
							...
							@if($value->id_idioma==1)
								<div class="row">
									...
									<div class="col-md-7">									
										...
										<p>{{$value->direccion}}</p>
										<a href="{{ URL::to('/administrador/Locales/Edit/'.$local.'/'.$depto->nombre.'/'.$key->id.'') }}">
											<h2 class="btn btn-primary">Editar</h2>
										</a>
										<a href="{{ URL::to('/administrador/Locales/Del/'.$local.'/'.$depto->nombre.'/'.$key->id.'') }}">
